...
# imports ceres packages from the directory on my laptop
import os
...
sim_sci, sim_sci_exptimes, flats, flats_exptimes, \
darks, darks_exptimes = ariesutils.FileClassify(dirin, log)
...
if (pre_process == 1):
    ...
    Dark_long, Dark_short = ariesutils.get_master_darks(darks, darks_exptimes)

    Flat = ariesutils.MedianCombine(flats)
...
#/home/lennart/api/aries/other/ceres-master/utils/GLOBALutils/
#     # Object name
